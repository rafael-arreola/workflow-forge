...
//! | `data.cast` | Conversiones declarativas por campo (fechas, números, strings) |
...
const CAST_INPUT_INVALID: &str = "CAST_INPUT_INVALID";
const CAST_FIELD_INVALID: &str = "CAST_FIELD_INVALID";
